...
// Return type for useFirebase() - now without storage
...
export const useAuth = (): Auth => {
  ...
  if (!context.auth) throw new Error('Authentication service not available.');
  return context.auth;
};
...
export const useFirebaseApp = (): FirebaseApp => {
  ...
  if (!context.firebaseApp) throw new Error('Firebase App service not available.');
